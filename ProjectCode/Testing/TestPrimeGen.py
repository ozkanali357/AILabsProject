...
class TestPrimeUtils(unittest.TestCase):
    def testeratosieve(self): # The method tests the sieve of eratosthenes function by calling the argument 30.
    ...
    def testmillerrabin(self): # We test the Miller Rabin Primality Test by checking it with 13 and 15.
    ...
    def testdobigprime(self): # We test if the function that generates large prime numbers can make it the specified amount (10 bits).
        prime = dobigprime(10)
